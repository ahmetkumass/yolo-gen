...
| **GLM-4.x-V** | 9B Flash, up to 106B MoE | `zai-org/GLM-4.6V-Flash`, `zai-org/GLM-4.6V`, `zai-org/GLM-4.5V`, `zai-org/GLM-4.1V-9B-Thinking` |
...
- [Qwen2.5-VL](https://huggingface.co/Qwen/Qwen2.5-VL-7B-Instruct) / [Qwen3-VL](https://huggingface.co/Qwen/Qwen3-VL-8B-Instruct) / [InternVL 3.5](https://huggingface.co/OpenGVLab/InternVL3_5-4B) / [GLM-4.6V](https://huggingface.co/zai-org/GLM-4.6V-Flash) — vision-language models
...
vlm:
  enabled: true
  model: Qwen/Qwen3-VL-4B-Instruct     # Qwen2.5-VL / Qwen3-VL / InternVL 3.5 / GLM-4.x-V supported
  epochs: 3
  precision: 4bit
